...
<div id="deleteModalPengeluaran" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
    <div style="background:white; border-radius:16px; padding:32px 28px; max-width:360px; width:90%; text-align:center;">
        ...
        <h3 style="font-size:18px; font-weight:700; margin-bottom:8px;">Hapus Pengeluaran?</h3>
        <p style="color:#666; margin-bottom:24px; font-size:14px;">Data ini akan dihapus secara permanen.</p>
        <div style="display:flex; gap:12px;">
            <button onclick="document.getElementById('deleteModalPengeluaran').style.display='none'" style="flex:1; padding:11px; border-radius:8px; border:1px solid #ddd; background:white; cursor:pointer; font-size:14px;">Batal</button>
            <button id="confirmDeletePengeluaran" style="flex:1; padding:11px; border-radius:8px; border:none; background:#e53e3e; color:white; cursor:pointer; font-size:14px; font-weight:700;">Ya, Hapus</button>
        </div>
    </div>
</div>
...
function deleteExpense(id) {
    document.getElementById('deleteModalPengeluaran').style.display = 'flex';
    document.getElementById('confirmDeletePengeluaran').onclick = function() {
