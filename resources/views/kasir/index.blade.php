            ...
            <form id="paymentForm">
                ...
                <div class="form-group-modal" id="cashPaymentSection">
                    ...
                    <div class="quick-amount">
                        <button type="button" class="quick-amount-btn" onclick="setQuickAmount(50000)">Rp
                            50.000</button>
                        <button type="button" class="quick-amount-btn" onclick="setQuickAmount(100000)">Rp
                            100.000</button>
                        <button type="button" class="quick-amount-btn" onclick="setQuickAmount(150000)">Rp
                            150.000</button>
                        <button type="button" class="quick-amount-btn" onclick="setQuickAmount(200000)">Rp
                            200.000</button>
                    </div>
